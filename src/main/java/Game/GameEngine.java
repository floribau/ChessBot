...
public class GameEngine {
  ...
  public synchronized static void initBoard(){
    ...
    board[0][0] = rook_black_0.getId();
    board[0][1] = knight_black_0.getId();
    board[0][2] = bishop_black_0.getId();
    board[0][3] = queen_black.getId();
    board[0][4] = king_black.getId();
    board[0][5] = bishop_black_1.getId();
    board[0][6] = knight_black_1.getId();
    board[0][7] = rook_black_1.getId();

    board[1][0] = pawn_black_0.getId();
    board[1][1] = pawn_black_1.getId();
    board[1][2] = pawn_black_2.getId();
    board[1][3] = pawn_black_3.getId();
    board[1][4] = pawn_black_4.getId();
    board[1][5] = pawn_black_5.getId();
    board[1][6] = pawn_black_6.getId();
    board[1][7] = pawn_black_7.getId();

    board[7][0] = rook_white_0.getId();
    board[7][1] = knight_white_0.getId();
    board[7][2] = bishop_white_0.getId();
    board[7][3] = queen_white.getId();
    board[7][4] = king_white.getId();
    board[7][5] = bishop_white_1.getId();
    board[7][6] = knight_white_1.getId();
    board[7][7] = rook_white_1.getId();

    board[6][0] = pawn_white_0.getId();
    board[6][1] = pawn_white_1.getId();
    board[6][2] = pawn_white_2.getId();
    board[6][3] = pawn_white_3.getId();
    board[6][4] = pawn_white_4.getId();
    board[6][5] = pawn_white_5.getId();
    board[6][6] = pawn_white_6.getId();
    board[6][7] = pawn_white_7.getId();

    controller.repaint(board);
  }
